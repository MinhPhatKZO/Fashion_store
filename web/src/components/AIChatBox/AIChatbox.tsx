...
const AIChatBox: React.FC = () => {
  ...
  const handleViewProducts = (products: ChatProduct[]) => {
  ...
  const handleSend = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const data: { reply?: string; products?: ChatProduct[] } =
        await response.json();
      ...
      {isOpen && (
        <div className="ai-chatbox-container">
          <div className="ai-chatbox-header">
            ...
            <button className="ai-chatbox-close" onClick={handleToggle}>
              ✕
            </button>
          </div>
                ...
                <div className="ai-chat-bubble">
                  ...
                  {msg.sender === "bot" &&
                    ...
                    msg.products.length > 0 && (
                      <div className="ai-chat-products-block">
                        <button
                          className="ai-chat-view-products-btn"
                          onClick={() =>
                            handleViewProducts(msg.products as ChatProduct[])
                          }
                        >
                          Xem sản phẩm
                        </button>
